...
export const activityRandomizerSlice = createAppSlice({
  ...
  reducers: create => ({
    ...
    resetActivityState: create.reducer(() => activityRandomizerInitialState)
  }),
  selectors: {
...
export const activityRandomizerActions = activityRandomizerSlice.actions;
export const activityRandomizerSelectors = activityRandomizerSlice.selectors;
